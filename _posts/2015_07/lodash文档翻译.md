title: lodash文档翻译
date: 2015-07-23 17:24:42
updated: 2015-07-23 17:24:45
tags:
- js
...
---
lodash是javascript语言中的瑞士军刀，其地位相当于C++中的stl
...
移除所有判为false的变量，并返回新数组，相当于执行了一个filter函数： `false`, `null`,
...
移除所有predicate函数返回为false的元素，thisArg用于指定predicate函数的this对象
predicate函数原型为：
```js
...
移除满足predicate函数条件的元素，函数有三个参数 (value, index, array)
...
返回的函数对象前n-1次都调用func，之后都返回第n-1次的结果
